# Docstrings are string literals that describe functions, methods, classes, or modules
# They serve as documentation for our code
# Unlike comments, docstrings can be called i.e., Print(Pet.__doc__) or Print(Pet.make_sound.__doc__)
